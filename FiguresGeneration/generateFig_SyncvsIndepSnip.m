...
load('listSyncvsIndepExamples.mat') %read this file to look at names of files and the associated notes
...
%% Load data
filepath = strcat('SyncIndep Segment Examples/',list.name{FileNum});
load(filepath);
experiment = ExpN;
...
[time,EKGData,SpO2Data,PArtData,CapnoData,FlowData,PActData,PPlData,PAbData,VolAutoData,VolAbsData,newVolAbsData,newVolAutoData] = trimData_exp(timeStart,45,time,EKGData,SpO2Data,PArtData,CapnoData,FlowData,PActData,PPlData,PAbData,VolAutoData,VolAbsData,newVolAbsData,newVolAutoData);
%%%%%%%%% Plotting Channels %%%%%%%%
...
writematrix(time', 'SourceData_nBME-21-2902.xlsx', 'Sheet', strcat('Fig4',figPrefix), 'Range','A2');
writematrix(PActData', 'SourceData_nBME-21-2902.xlsx', 'Sheet', strcat('Fig4',figPrefix), 'Range','B2');
writematrix(FlowData', 'SourceData_nBME-21-2902.xlsx', 'Sheet', strcat('Fig4',figPrefix), 'Range','C2');
writematrix(VolAutoData', 'SourceData_nBME-21-2902.xlsx', 'Sheet', strcat('Fig4',figPrefix), 'Range','D2');
