function analyzeMinVentAndABG(date,TminVent,PminVent,NminVent, T,ABGTimes,pHvalues,pCO2values,pO2values,sO2values, baseline, SDbaseline,time, PActData,DateTime,plotsON)
...
for i = 1:length(ABGTimes)
    abgIndex = find(ABGDataCompiled{:, 1} == ABGTimes(i)); 
